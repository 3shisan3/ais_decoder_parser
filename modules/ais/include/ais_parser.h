...
public:
     ...
     * @param cfg 配置
     */
    explicit AISParser(const AISParseCfg &cfg = AISParseCfg());
     ...
     * @param newConfig 新配置
     */
    void setConfig(const AISParseCfg &newConfig);

    /**
     * @brief 获取当前配置
     * @return 当前配置的引用
     */
    const AISParseCfg &getConfig() const;

private:
    AISParseCfg config_; // 解析器配置
